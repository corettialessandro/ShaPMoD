    ...
    while (discr > LOW_TOL) { //Verifying the constraint condition
        ...
        for (k=0; k<NPART; k++) { //Looping on all constraints
            ...
            if (POT == 'J') {
                ...
                DPhixDrho_old = ConstTens_Jac(rho_OLD, r_tp1, k, k).fx;
            ...
            denom = (DPhixDrho_old.y*DPHIDVRHO_T[k][k].fx.y*DT + DPhixDvrho_old.y*(DPHIDVRHO_T[k][k].fx.y + DPhixDvrho_old.y));
            ...
            denom = (DPhiyDrho_old.x*DPHIDVRHO_T[k][k].fy.x*DT + DPhiyDvrho_old.x*(DPHIDVRHO_T[k][k].fy.x + DPhiyDvrho_old.x));
            ...
            for (i=0; i<NPART; i++) {
                ...
                denom += DT*(DPHIZDRHO_TP1[i].x*DPHIDVRHO_T[k][i].fz.x + DPHIZDRHO_TP1[i].y*DPHIDVRHO_T[k][i].fz.y + DPHIZDRHO_TP1[i].z*DPHIDVRHO_T[k][i].fz.z);
            }
            ...
            vrho_OLD[k].x -= (GAMMA[k].y*(DPHIDVRHO_T[k][k].fy.x + DPhiyDvrho_old.x));
            vrho_OLD[k].y -= (GAMMA[k].x*(DPHIDVRHO_T[k][k].fx.y + DPhixDvrho_old.y));
            vrho_OLD[k].z -= 0;
            ...
            for (i=0; i<NPART; i++) {
                ...
                vrho_OLD[i].x -= (GAMMA[k].z*(DPHIDVRHO_T[k][i].fz.x + DPHIZDRHO_TP1[i].x));
                vrho_OLD[i].y -= (GAMMA[k].z*(DPHIDVRHO_T[k][i].fz.y + DPHIZDRHO_TP1[i].y));
                vrho_OLD[i].z -= (GAMMA[k].z*(DPHIDVRHO_T[k][i].fz.z + DPHIZDRHO_TP1[i].z));
            }
