...
#define _MAX_ITER 1e3           //Maximum number of allowed iterations for reaching convergence
#define _MAX_ATT 2              //Maximum number of attempts to get out from a local minimum
#define _SR_CG_LOW_TOL 1e-8    //Lower Tolerance for shell relaxation - Conjugate Gradient
